  ...
  theme: {
    extend: {
      colors: {
        ...
        // — Neutres structurels —
        navy:     "hsl(213 51% 18%)", // aussi "#172E42"
        charcoal: "#2A262A",
        surface:  "#F8F9FA",
        // — Système shadcn/ui (CSS vars) —
      ...
      boxShadow: {
        soft:        "0 4px 20px rgba(23,46,66,0.08)",  // config 2 (plus précis)
        card:        "0 8px 30px rgba(23,46,66,0.1)",   // config 2 (plus précis)
