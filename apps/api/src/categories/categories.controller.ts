...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description: 'Récupère la liste de toutes les catégories (route publique)',
  })
  @ApiQuery({
  ...
  @ApiParam({
    name: 'slug',
    description: 'Slug de la catégorie (ex: culture-generale)',
  })
  @ApiResponse({ status: 200, description: 'Catégorie trouvée' })
  @ApiResponse({ status: 404, description: 'Catégorie non trouvée' })
  ...
  @Get(':id/themes')
  @ApiOperation({
    summary: "Thèmes d'une catégorie",
    description: 'Récupère tous les thèmes associés à une catégorie',
  })
  @ApiParam({ name: 'id', description: 'ID de la catégorie' })
