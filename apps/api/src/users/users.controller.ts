...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Récupère la liste des utilisateurs avec filtres et pagination (Admin uniquement)',
  })
  @ApiQuery({
    name: 'role',
    required: false,
  ...
  @ApiOperation({
    ...
    description: "Bascule le statut actif d'un utilisateur",
  })
  @ApiParam({ name: 'id', description: "ID de l'utilisateur" })
  ...
  @Permissions('manage:users')
  @ApiOperation({
    summary: "Modifier le profil d'un utilisateur (admin)",
    description: 'Permet à un admin de modifier les informations de profil',
  })
  @ApiParam({ name: 'id', description: "ID de l'utilisateur" })
  @ApiBody({
    schema: {
  ...
  @ApiOperation({
    ...
    description: 'Bannit un utilisateur de la plateforme',
  })
  @ApiParam({ name: 'id', description: "ID de l'utilisateur" })
